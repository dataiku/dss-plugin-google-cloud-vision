...
from google_vision_api_formatting import ImageTextDetectionAPIFormatter
from dku_io_utils import set_column_description

params = PluginParamsLoader(RecipeID.IMAGE_TEXT_DETECTION).validate_load_params()
...
api_formatter = ImageTextDetectionAPIFormatter(**vars(params))
